...
namespace RosSharp.RosBridgeClient
{
    ...
    {
        // Jog Frame stuff
        protected JogFrameAbsPublisher JFAPublisher;
        ...
        protected void SetJogGoal()
        {
            ...
            JFAPublisher.InputTransform.SetPositionAndRotation(goalTransform.transform.position, goalTransform.transform.rotation);
        }
