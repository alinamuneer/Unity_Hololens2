...
{
    public class PR2GripperEventDetectorCommand : Message
    {
        public const string RosMessageName = "pr2_gripper_sensor_msgs/PR2GripperEventDetectorCommand";
        ...
        public double acceleration_trigger_magnitude { get; set; }
        ...
        public double slip_trigger_magnitude { get; set; }

        public PR2GripperEventDetectorCommand()
        {
        ...
        public PR2GripperEventDetectorCommand(sbyte trigger_conditions, double acceleration_trigger_magnitude, double slip_trigger_magnitude)
        {
            this.trigger_conditions = trigger_conditions;
            this.acceleration_trigger_magnitude = acceleration_trigger_magnitude;
            this.slip_trigger_magnitude = slip_trigger_magnitude;
        }
    }
}
